...
func TestCustomTransactionDataDsvFileImporter_WithAllSupportedColumns(t *testing.T) {
	...
	importer, err := CreateNewCustomTransactionDataDsvFileImporter("custom_csv", "utf-8", columnIndexMapping, transactionTypeMapping, true, "YYYY-MM-DD HH:mm:ss", "", "Z", "", " ", " ", "lonlat", ";")
	assert.Nil(t, err)
	...
	assert.Equal(t, "Test Category:::Test Sub Category", allNewTransactions[1].OriginalCategoryName)
	...
	assert.Equal(t, "Test Category2:::Test Sub Category2", allNewTransactions[2].OriginalCategoryName)
	...
	assert.Equal(t, "Test Category3:::Test Sub Category3", allNewTransactions[3].OriginalCategoryName)
...
func TestCustomTransactionDataDsvFileImporter_ParseTimeWithTimezone(t *testing.T) {
	...
	importer, err := CreateNewCustomTransactionDataDsvFileImporter("custom_csv", "utf-8", columnIndexMapping, transactionTypeMapping, false, "YYYY-MM-DD HH:mm:ssZ", "", "Z", "", "", "", "", "")
	assert.Nil(t, err)
...
func TestCustomTransactionDataDsvFileImporter_ParseTimeWithTimezone2(t *testing.T) {
	...
	importer, err := CreateNewCustomTransactionDataDsvFileImporter("custom_csv", "utf-8", columnIndexMapping, transactionTypeMapping, false, "YYYY-MM-DD HH:mm:ssZZ", "", "Z", "", "", "", "", "")
	assert.Nil(t, err)
...
func TestCustomTransactionDataDsvFileImporter_ParseValidTimezone2(t *testing.T) {
	...
	importer, err := CreateNewCustomTransactionDataDsvFileImporter("custom_csv", "utf-8", columnIndexMapping, transactionTypeMapping, false, "YYYY-MM-DD HH:mm:ss", "ZZ", "ZZ", "", "", "", "", "")
	assert.Nil(t, err)
...
func TestCustomTransactionDataDsvFileImporter_ParsePrimaryCategory(t *testing.T) {
	...
	allNewTransactions, _, allNewSubExpenseCategories, allNewSubIncomeCategories, allNewSubTransferCategories, _, _, err := importer.ParseImportedData(context, user, []byte(
		"2024-09-01 00:00:00,B,,123.45\n"+
	...
	assert.Equal(t, models.TRANSACTION_DB_TYPE_INCOME, allNewTransactions[1].Type)
	assert.Equal(t, int64(1725153825), utils.GetUnixTimeFromTransactionTime(allNewTransactions[1].TransactionTime))
	assert.Equal(t, "Test Category:::Test Category", allNewTransactions[1].OriginalCategoryName)

	assert.Equal(t, int64(1234567890), allNewTransactions[2].Uid)
	assert.Equal(t, models.TRANSACTION_DB_TYPE_EXPENSE, allNewTransactions[2].Type)
	assert.Equal(t, int64(1725194096), utils.GetUnixTimeFromTransactionTime(allNewTransactions[2].TransactionTime))
	assert.Equal(t, "Test Category2:::Test Category2", allNewTransactions[2].OriginalCategoryName)

	assert.Equal(t, int64(1234567890), allNewTransactions[3].Uid)
	assert.Equal(t, models.TRANSACTION_DB_TYPE_TRANSFER_OUT, allNewTransactions[3].Type)
	assert.Equal(t, int64(1725235199), utils.GetUnixTimeFromTransactionTime(allNewTransactions[3].TransactionTime))
	assert.Equal(t, int64(5), allNewTransactions[3].Amount)
	assert.Equal(t, "Test Category3:::Test Category3", allNewTransactions[3].OriginalCategoryName)
...
func TestCustomTransactionDataDsvFileImporter_ParseInvalidAccountCurrency(t *testing.T) {
	...
	_, _, _, _, _, _, newCurrencies, err := importer.ParseImportedData(context, user, []byte(
		"2024-09-01 01:23:45,B,Test Account,USD,123.45,,,\n"+
...
func TestCustomTransactionDataDsvFileImporter_ParseTag(t *testing.T) {
	...
	_, _, _, _, _, allNewTags, _, err := importer.ParseImportedData(context, user, []byte(
