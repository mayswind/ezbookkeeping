...
var (
	...
	ErrCannotSetCreditLimitForNonCreditCardAccount    = NewNormalError(NormalSubcategoryAccount, 27, http.StatusBadRequest, "cannot set credit limit for non credit card account")
	ErrCannotSetCreditLimitForSubAccount              = NewNormalError(NormalSubcategoryAccount, 28, http.StatusBadRequest, "cannot set credit limit for sub account")
	ErrMustSetParentAccountCurrencyWhenSetCreditLimit = NewNormalError(NormalSubcategoryAccount, 29, http.StatusBadRequest, "must set parent account currency when set credit limit")
)
