...
Prompt 1: "Atue como um especialista em Product Discovery. Considerando o sistema de finanças open source ezBookkeeping, que atualmente não possui funcionalidade de Metas/Orçamentos, crie duas personas de estudantes universitários que sofreriam com essa limitação. Foque em metas reais da vida acadêmica, como economizar para eventos estudantis ou taxas de inscrição de provas."

Prompt 2: "Com base na Persona 1, construa um Mapa de Empatia estruturado (Pensa e Sente, Escuta, Vê, Fala e Faz)."
